...
var _rcTable = require('rc-table-fb');
...
var Table = function (_React$Component) {
    ...
    function Table(props) {
        ...
        (0, _warning2["default"])(!('columnsPageRange' in props || 'columnsPageSize' in props), '`columnsPageRange` and `columnsPageSize` are removed, please use ' + '[fixed columns](http://diy-design.me/n.html?%2F&port=8001/components/table/#components-table-demo-fixed-columns) ' + 'instead.');
